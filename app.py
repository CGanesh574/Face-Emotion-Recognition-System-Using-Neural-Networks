...
class FaceRecognitionApp:
    ...
    def start_face_capture(self):
        ...
        self.name_entry.config(state="disabled")  # Disable name entry during capture
        self.capture_faces()
    ...
    def stop_face_capture(self):
        ...
        self.name_entry.config(state="normal")  # Re-enable name entry after capture
        self.name_entry.delete(0, tk.END)  # Clear name entry for next user
        self.stop_camera()
